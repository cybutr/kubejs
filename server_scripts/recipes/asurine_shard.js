ServerEvents.recipes(event => {
    ...
    event.recipes.create.sequenced_assembly([Item.of('kubejs:asurine_shard', 5).withChance(0.75), Item.of('kubejs:asurine_shard', 3).withChance(0.20), Item.of('minecraft:light_blue_dye', 1).withChance(0.05)],
    Item.of('kubejs:obsidian_alloy'),
        ...
        event.recipes.createFilling(inter, [inter, Fluid.of('kubejs:zinc_solution', 270)]),
