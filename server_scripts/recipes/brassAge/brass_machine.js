ServerEvents.recipes(event => {
    ...
    event.recipes.create.sequenced_assembly('kubejs:brass_machine', 'kubejs:andesite_machine',
        [event.recipes.createFilling(inter2, [inter2, Fluid.of('tconstruct:molten_brass', 360)]),
        ...
        event.recipes.createDeploying(inter2, [inter, '#forge:screwdrivers'])]).transitionalItem(inter).loops(1).id('kubejs:sequenced_assembly/brass_machine')
})