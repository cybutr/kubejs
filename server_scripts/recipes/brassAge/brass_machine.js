ServerEvents.recipes(event => {
    ...
    event.recipes.create.sequenced_assembly('kubejs:brass_machine', 'kubejs:andesite_machine',
        ...
        event.recipes.createFilling(inter2, [inter2, Fluid.of('tconstruct:molten_brass', 180)])]).transitionalItem(inter2).loops(1).id('kubejs:sequenced_assembly/brass_machine')
})