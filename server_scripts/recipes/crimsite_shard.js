ServerEvents.recipes(event => {
    ...
    event.recipes.create.sequenced_assembly([Item.of('kubejs:crimsite_shard', 5).withChance(0.80), Item.of('kubejs:crimsite_shard', 3).withChance(0.20)],
    Item.of('kubejs:obsidian_alloy'),
        [
        event.recipes.createFilling(inter, [inter, Fluid.of('kubejs:molten_redstone', 135)]),
