ServerEvents.recipes(event => {
    ...
    event.recipes.create.emptying([Fluid.of('create_dd:chromatic_waste', 75), 'create_dd:compound_base'], 'create_dd:chromatic_compound').id('kubejs:emptying/chromatic_compound')
})