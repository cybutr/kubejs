ServerEvents.recipes(event => {
    event.recipes.create.crushing(
        [Item.of('kubejs:crushed_deepslate', 2), Item.of('kubejs:crushed_deepslate').withChance(0.5)],
        Item.of('#kubejs:deepslate', 1))
        .processingTime(180).id('kubejs:crushing/crushed_deepslate')
    event.recipes.create.crushing([Item.of('kubejs:limestone_shard', 3), Item.of('kubejs:limestone_shard').withChance(0.5)], '#kubejs:limestones')
